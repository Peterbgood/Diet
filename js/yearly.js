  ...
  if (storedData) {
    ...
    entries.forEach((entry) => {
      if (entry) {
        ...
        borderColors.push(color === 'rgba(220, 53, 69, 0.2)' ? 'rgba(220, 53, 69, 1)' : 'rgba(0, 123, 255, 0.7)');
      }
    });
    labels.reverse();
    data.reverse();
    ...
    chart.data.datasets[0].borderColor = borderColors; // Use borderColor array
